...
public class DocumentEntityService {
    ...
    public DocumentEntity postDocument(DocumentEntity document, Long driverId, String documentName) throws EntityAlreadyExistsException {
        // getDocumentById(documentId);
         var driver = getDriverById(driverId);
         var documents = documentEntityRepository.findByDriver_DriverId(driverId);
            if (documents == null) {
